...
public final class ItemOrderProductBinding implements ViewBinding {
  ...
  private ItemOrderProductBinding(@NonNull LinearLayout rootView,
  ...
  public static ItemOrderProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemOrderProductBinding((LinearLayout) rootView, imageViewProduct, textViewPrice,
          textViewProductName, textViewQuantity, textViewSubtotal);
    }

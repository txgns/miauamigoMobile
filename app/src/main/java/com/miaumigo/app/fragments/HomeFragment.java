...
public class HomeFragment extends Fragment implements ProductAdapter.OnProductClickListener {
    ...
    private void setupRecyclerView() {
        productAdapter = new ProductAdapter(featuredProducts, this);
        recyclerViewFeaturedProducts.setLayoutManager(new GridLayoutManager(getContext(), 2));
        recyclerViewFeaturedProducts.setAdapter(productAdapter);
    }
    ...
    private void showLoading(boolean show) {
        ...
        recyclerViewFeaturedProducts.setVisibility(show ? View.GONE : View.VISIBLE);
    }
